        ...
        <header class="header">
            <div class="top-bar">
                <div class="container">
                    ...
                    <ul class="phones">
                        <li><a href="tel:8121-416-416"><span>Taxi</span> 000000</a></li>
                        <li><a href="tel:8121-416-416"><span>Garage</span> 00000000</a></li>
                        <li><a href="tel:8121-416-416"><span>Contact</span> 0000000</a></li>
                    </ul>
                </div>
            </div>
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-3">
							<div class="widget">
								<h6>Contact</h6>
								<ul class="contact">
									<li class="hotline"><a href="tel:8121-416-416">0000000</a></li>
									<li class="phone"><a href="tel:212-647-0772">000000</a></li>
									<li class="email"><a href="mailto:info@taxigrabber.biz">aaa@gmail.com</a></li>
									<li class="address">4603 townhall Avenue<br>coimbatore</li>
								</ul>
							</div>
						</div>
					</div>
